...
// MFCApp2.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMFCApp2App

CMFCApp2App theApp;


// Инициализация CMFCApp2App
...
// Обработчики сообщений CMFCApp2App
...
// Методы загрузки или сохранения настроек CMFCApp2App
